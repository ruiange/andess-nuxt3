      ...
      <div class="flex justify-center mt-12">
        <div class="flex gap-2">
          ...
          <button 
            ...
            :class="page === 1 ? 'bg-[var(--td-brand-color)] text-white border-[var(--td-brand-color)]' : 'border-gray-200 text-gray-600'"
          >
            {{ page }}
          </button>
          <button class="w-10 h-10 flex items-center justify-center rounded border border-gray-200 text-gray-600">
...
const allNews = [
  ...
  {
    id: "4",
    title: "安实创业与清华大学建立产学研合作关系",
    summary: "近日，安实创业与清华大学材料学院签署战略合作协议，双方将在新型建材研发、人才培养等方面展开深入合作，共同推动建材行业技术创新。",
    date: "2025-02-25",
    views: "2,567",
    category: "公司新闻",
    image: "https://public.readdy.ai/ai/img_res/d3cd44578f77a34f667116b3c5fc0513.jpg"
  ...
  {
    id: "6",
    title: "《建筑时报》专访安实创业董事长：创新是企业发展的不竭动力",
    summary: "近日，《建筑时报》对安实创业董事长张志远进行了专访，张董事长分享了公司的创新理念、发展战略以及对行业未来的展望。",
    date: "2025-02-15",
    views: "3,567",
    category: "媒体报道",
    image: "https://public.readdy.ai/ai/img_res/d3cd44578f77a34f667116b3c5fc0513.jpg"
  ...
  {
    id: "8",
    title: "安实创业推出新一代智能防水系统，实现远程监测与预警",
    summary: "安实创业近日推出新一代智能防水系统，通过嵌入式传感器和云平台，实现对建筑防水层的实时监测和预警，大幅提升防水工程的可靠性和使用寿命。",
    date: "2025-02-05",
    views: "3,124",
    category: "技术动态",
    image: "https://public.readdy.ai/ai/img_res/3bde06f6373ffb6dae597dff678a06e1.jpg"
  ...
  {
    id: "9",
    title: "安实创业成功入选国家级绿色工厂名单",
    summary: "近日，工信部公布2025年国家级绿色工厂名单，安实创业凭借在节能减排、清洁生产等方面的突出表现，成功入选，成为建材行业的绿色发展标杆。",
    date: "2025-01-28",
    views: "2,765",
    category: "公司新闻",
    image: "https://public.readdy.ai/ai/img_res/d3cd44578f77a34f667116b3c5fc0513.jpg"
