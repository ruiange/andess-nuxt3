      ...
      <article class="bg-white rounded-xl p-12 shadow-sm mb-12">
        ...
        <div class="prose max-w-none">
          ...
          <div v-if="news.id === '2'">
            ...
            <p class="mb-6">
              建材之家研发团队历时两年，在环保地坪材料领域取得重大突破。新一代环保型环氧地坪材料采用创新配方，在保持优异物理性能的同时，显著降低了环境影响。主要技术突破包括：
            </p>
...
const newsData = {
  "1": {
    ...
    content: [
      ...
      "本次峰会由中国建材协会主办，汇集了全国各地的建材行业领军企业和专家学者。建材之家作为行业内知名企业，展示了多项环保建材创新产品，包括零VOC环氧地坪系统、高性能隔热保温材料等，引起了与会者的广泛关注。",
      "公司董事长张志远在获奖致辞中表示：'建材之家一直秉持创新驱动发展的理念，将环保与性能完美结合，为客户提供更加优质、环保的建材产品。未来，我们将继续加大研发投入，推动行业技术进步，为建设美丽中国贡献力量。'",
      "据悉，建材之家研发的零VOC环氧地坪系统采用全新配方，在保持优异物理性能的同时，VOC释放量较传统产品降低85%，已成功应用于多个医院、学校等对空气质量要求较高的场所。",
      "此外，公司自主研发的新型隔热保温材料，导热系数低至0.023W/(m·K)，比传统材料提升30%的保温效果，有效降低建筑能耗，助力'双碳'目标实现。",
      "中国建材协会秘书长李明在颁奖词中指出：'建材之家在环保建材领域的创新成果，不仅提升了产品性能，更为行业绿色发展树立了标杆。希望更多企业能够向建材之家学习，将创新与环保相结合，推动建材行业高质量发展。'",
      "据了解，建材之家近年来持续加大研发投入，研发经费占销售收入的比例已达5%，远高于行业平均水平。公司拥有一支由博士、硕士组成的专业研发团队，并与多所高校建立了产学研合作关系。",
      "获此殊荣，建材之家将继续秉持'创新、环保、品质'的发展理念，不断推出更多满足市场需求的优质建材产品，为客户创造更大价值。"
    ]
  },
  "2": {
    id: "2",
  ...
  "3": {
    ...
    content: [
      ...
      "本次亚运会场馆项目是建材之家承接的重点工程之一，涉及主体育场、游泳馆、体育馆等多个场馆的防水、地坪、保温等多个系统的施工。项目总面积超过10万平方米，是公司近年来承接的最大规模体育场馆项目。",
      ...
      "项目完工后，经过严格的质量检测和验收，各项指标均达到或超过设计要求和国家标准。业主方对项目质量和服务给予了高度评价，认为建材之家的产品和服务达到了国际一流水平。",
